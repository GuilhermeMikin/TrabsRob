...
//SELECIONAR SENSORES ANAG OU DIGITAIS//
...
int Vel_up = 50;   // Velocidade de subida
...
int ENA = 10; // motor esquerdo
int ENB = 9; //motor direito
...
//  leitura4 = analogRead(sensor_4);
  ...
  leitura3 = digitalRead(sensor_3);
  leitura4 = digitalRead(sensor_4);
...
//  if (leitura0 < LIMIAR_SENSORES && leitura1 < LIMIAR_SENSORES && leitura2 > LIMIAR_SENSORES && leitura3 < LIMIAR_SENSORES && leitura4 < LIMIAR_SENSORES)
//  {
//
...
//  }
  ...
  if (leitura0 == 0 && leitura1 == 0 && leitura2 == 1 && leitura3 == 0 && leitura4 == 0)
  {

    array_sensores = 0b00100;

  } else if (leitura0 == 0 && leitura1 == 0 && leitura2 == 0 && leitura3 == 1 && leitura4 == 0)
  {

    array_sensores = 0b00010;

  } else if (leitura0 == 0 && leitura1 == 0 && leitura2 == 1 && leitura3 == 1 && leitura4 == 0)
  {

    array_sensores = 0b00110;

  } else if (leitura0 == 0 && leitura1 == 1 && leitura2 == 0 && leitura3 == 0 && leitura4 == 0)
  {

    array_sensores = 0b01000;

  } else if (leitura0 == 0 && leitura1 == 1 && leitura2 == 1 && leitura3 == 0 && leitura4 == 0)
  {

    array_sensores = 0b01100;

  } else if (leitura0 == 1 && leitura1 == 1 && leitura2 == 0 && leitura3 == 0 && leitura4 == 0)
  {

    array_sensores = 0b11000;

  } else if (leitura0 == 1 && leitura1 == 1 && leitura2 == 1 && leitura3 == 0 && leitura4 == 0)
  {

    array_sensores = 0b11100;

  } else if (leitura0 == 1 && leitura1 == 0 && leitura2 == 0 && leitura3 == 0 && leitura4 == 0)
  {

    array_sensores = 0b10000;

  }else if (leitura0 == 0 && leitura1 == 0 && leitura2 == 1 && leitura3 == 1 && leitura4 == 1)
  {

    array_sensores = 0b00111;

  } else if (leitura0 == 0 && leitura1 == 0 && leitura2 == 0 && leitura3 == 1 && leitura4 == 1)
  {

    array_sensores = 0b00011;

  } else if (leitura0 == 0 && leitura1 == 0 && leitura2 == 0 && leitura3 == 0 && leitura4 == 1)
  {
  ...
  else if (leitura0 == 0 && leitura1 == 1 && leitura2 == 1 && leitura3 == 1 && leitura4 == 1)
  {

    array_sensores = 0b01111;

  } else if (leitura0 == 1 && leitura1 == 1 && leitura2 == 1 && leitura3 == 1 && leitura4 == 0)
  {

    array_sensores = 0b11110;

  } else if (leitura0 == 0 && leitura1 == 0 && leitura2 == 0 && leitura3 == 0   && leitura4 == 0)
  {

    array_sensores = 0b00000;
  ...
  } else if (array_sensores == 0b01111) {

    erro_array = -5;

  } else if (array_sensores == 0b00000) {
